...
const COURSE_SEEDS: Course[] = [
  ...
  },
  {
    ...
    bannerColorClass: 'bg-gradient-to-br from-[#123A6B] to-[#4F86D8]',
    bannerEmoji: 'QA',
    description: 'Practice test planning, unit testing, integration testing, and defect reporting for maintainable software products.',
    instructorName: 'Dr. Wulan Hartati',
    instructorInitials: 'WH',
    instructorRole: 'Software Quality Lecturer',
    creditHours: 3,
  ...
  },
  {
    ...
    bannerColorClass: 'bg-gradient-to-br from-[#173660] to-[#608CD2]',
    bannerEmoji: 'DO',
    description: 'Introduce CI/CD workflows, environment configuration, release planning, and collaboration between development and operations teams.',
    instructorName: 'Ir. Galih Pranata',
    instructorInitials: 'GP',
    instructorRole: 'DevOps Engineering Lecturer',
    creditHours: 3,
    progressPercentage: 0,
    status: 'notstart',
    totalMaterials: 10,
